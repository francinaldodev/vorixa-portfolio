...
![Cardápio digital responsivo](docs/images/03-cardapio-mobile.jpeg)

### Cadastro de produtos

![Cadastro e gerenciamento de produtos](docs/images/04-cadastro-produtos.png)

### PDV

![Ponto de venda VORIXA](docs/images/05-pdv.png)

### Gestão de caixa

![Abertura, movimentação e fechamento de caixa](docs/images/06-gestao-caixa.png)

### Histórico de caixas

![Histórico de vendas, estornos e movimentações](docs/images/07-historico-caixas.png)

### Central de pedidos

![Pedidos, faturamento e relatórios](docs/images/08-central-pedidos.png)

### Encomendas para festas

![Montagem de encomendas para festas](docs/images/09-encomendas-festas.png)

### Área do contador

![Empresas autorizadas para o contador](docs/images/10-area-contador-empresas.png)

![Informações contábeis autorizadas](docs/images/11-area-contador-detalhes.png)
